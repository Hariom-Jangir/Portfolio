    ...
    >
      <div className="container mx-auto text-center">
        ...
        >
          ...
          >
            Building innovative software solutions and continuously learning at
          ...
          >
            <motion.a
              ...
              href="#projects"
              className="gradient-bg text-primary-foreground px-8 py-3.5 rounded-xl font-medium text-sm inline-flex items-center justify-center gap-2 shadow-lg"
            >
            ...
            <motion.a
              ...
              href="#contact"
              className="glass-card px-8 py-3.5 rounded-xl font-medium text-sm text-foreground inline-flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="glass-card px-8 py-3.5 rounded-xl font-medium text-sm text-foreground inline-flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 active:scale-95 hover:bg-secondary/20 min-h-[44px]"
            >
